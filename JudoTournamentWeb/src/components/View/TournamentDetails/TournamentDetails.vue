    ...
    <div class="tournament-details">
        ...
        <div class="tournament-detail-header">
            <button
                class="back-button"
                @click="goBack"
                :title="t('tournamentDetails.back')"
            >
                <svg
                    width="28"
                    height="28"
    ...
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      >
        ...
        <div v-else-if="error" class="error">
            <p>{{ error }}</p>
            <button class="retry-button" @click="loadTournamentDetail">
...
const tabComponents = {
    ...
    athletes: defineAsyncComponent(
        () => import("@/components/View/TournamentDetails/AthletesTab.vue"),
    ),
    weighing: defineAsyncComponent(
        () => import("@/components/View/TournamentDetails/WeightingTab.vue"),
    ),
    ...
    live: defineAsyncComponent(
        () => import("@/components/View/TournamentDetails/LiveTab.vue"),
    ),
};
...
const loadTournamentDetail = async () => {
    ...
    try {
        ...
        if (isNaN(tournamentId))
            throw new Error(t("tournamentDetails.invalidId"));
